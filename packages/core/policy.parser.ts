 ...
 */
export function parseYaml(yamlContent: string): Policy {
  try {
...
function parseSimpleYaml(content: string): any {
  ...
  const result: any = { version: 1, profiles: {}, defaults: { approvals_ttl_seconds: 3600 } };
...
function parseProfileField(profile: any, key: string, value: string) {
  switch (key) {
    case 'read_only':
...
function parseDefaultsField(defaults: any, key: string, value: string) {
  switch (key) {
