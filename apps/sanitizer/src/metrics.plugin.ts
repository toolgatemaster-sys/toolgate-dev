...
// Create custom metrics for sanitizer
const httpRequestsTotal = new Counter({
  name: 'sanitizer_http_requests_total',
  help: 'Total number of HTTP requests to sanitizer',
  labelNames: ['method', 'status']
});

const httpRequestDuration = new Histogram({
  name: 'sanitizer_http_request_duration_seconds',
